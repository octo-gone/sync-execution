...
window.onload = function () {
    ...
    var canvas = document.getElementById("match-3");
    var div_base = document.getElementById("match-3-base");
    ...
    function drawTile(x, y, r, g, b) {
        ...
        var c = -1;
        tilecolors.forEach(function (item, i) {
            if (item[0] == r, item[1] == g, item[2] == b) {
                c = i
            }
        })
        if (c >= 0) {
            context.fillText("" + (c + 1), x + 12, y + 2 + 24);
        }
    }
