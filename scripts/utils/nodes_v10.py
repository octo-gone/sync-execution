base_nodes_info = {
    ...
    'and': {
        ...
        'tooltip': {
            ...
            'adds': 'На вход может подаваться любые значение, которые можно привести к логическим True или False. Для числа 0, пустого символа или None приводимое логическое значение будет False',
        }
    },
    'not and': {
        'inputs': ('mult',),
    ...
    'bool': {
        ...
        'tooltip': {
            ...
            'adds': 'На вход может подаваться любое значение, которое можно привести к логическим True или False. Для числа 0, пустого символа или None приводимое логическое значение будет False',
        }
    },
    'const': {
        'inputs': (),
